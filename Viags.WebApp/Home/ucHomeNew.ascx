<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucHomeNew.ascx.cs" Inherits="Viags.WebApp.Home.ucHome" %>
    ...
    <div class="col-md-8 col-sm-8" id="home_left" style="padding-right: 0px;">    
        <div class="card bg-gradient-danger">
            ...
            <div class="card-body scroll">
                <img src="http://www.bootstrapdash.com/demo/purple-admin-free/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image">
                <a class="link-list" data-toggle="collapse" href="#collapse1">
                    <h4 class="font-weight-normal mb-3">Công việc
                        <i class="mdi mdi-chart-line mdi-24px float-right"></i>
                    </h4>
                </a> 
                <div class="collapse in " id="collapse1">
                    <div class="col-md-4 col-sm-4 padding-in-home">
                        <a href="../Pagess/van-ban-den.aspx">
        ...
        <div class="card bg-gradient-info">
            ...
            <div class="card-body scroll">
                <img src="http://www.bootstrapdash.com/demo/purple-admin-free/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image">
                <a class="link-list" data-toggle="collapse" href="#collapse2">
                    <h4 class="font-weight-normal mb-3">Tiện ích
                        <i class="mdi mdi-chart-line mdi-24px float-right"></i>
                    </h4>
                </a>                
        ...
        <div class="card bg-gradient-success">
            ...
            <div class="card-body scroll">
                <img src="http://www.bootstrapdash.com/demo/purple-admin-free/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image">
                <a class="link-list" data-toggle="collapse" href="#collapse3">
                    <h4 class="font-weight-normal mb-3">Khác
                        <i class="mdi mdi-chart-line mdi-24px float-right"></i>
                    </h4>
                </a> 
        ...
        <div id="myCarousels" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                ...
                <div class="item active">
                    <img src="http://webapplayers.com/inspinia_admin-v2.9.2/img/p_big1.jpg" alt="Los Angeles" style="width:100%;">
                ...
                <div class="item">
                    <img src="http://webapplayers.com/inspinia_admin-v2.9.2/img/p_big2.jpg" alt="Chicago" style="width:100%;">
                    <div class="carousel-caption">
                        <h3>Chicago</h3>
                ...
                <div class="item">
                    <img src="http://webapplayers.com/inspinia_admin-v2.9.2/img/p_big3.jpg" alt="New York" style="width:100%;">
                    <div class="carousel-caption">
                        <h3>New York</h3>
