<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucMenuLeftNew.ascx.cs" Inherits="Viags.WebApp.Common.ucMenuLeftNew" %>
...
<div class="page-sidebar-wrapper">
    ...
    <div class="page-sidebar navbar-collapse collapse">
        ...
        <ul class="page-sidebar-menu  " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
            <li class="sidebar-toggler-wrapper toggled" id="btnHideMenu" title="Ẩn hiện menu trái">
                <!-- BEGIN SIDEBAR TOGGLER BUTTON -->
                <div class="sidebar-toggler" id="IdMenuToggle" style="float: left">
                </div>
                ...
                <ul class="sub-menu">
                    ...
                    <li>
                        ...
                        <ul class="sub-menu">
                            ...
                            <%if (CurrentUser.ViTriID == (int)Viags.Utils.Enum.TypeOfRole.VanThuDonVi)
                                { %>
                            <li><a title="" href="/Pagess/van-ban-cho-vao-so.aspx"><i class="fa fa-book "></i>Văn bản chờ vào sổ <b id="idvanbanduthaochovaoso"></b></a></li>
                            <%} %>
                            ...
                            <%if (CheckQuyen(CurrentUser.QuyenHan, (int)Viags.Utils.Enum.QuyenHan.ChuyenPhatBuuDien))
                                { %>
                            <li>
                                <a title="" href="#"><i class="fa fa-envelope"></i>Quản lý chuyển phát<span class="arrow"></span></a>
                                <ul class="sub-menu">
                                    <%if (CheckQuyen(CurrentUser.QuyenHan, (int)Viags.Utils.Enum.QuyenHan.ChuyenPhatHanhQuaBuuDien))
                                        {%>
                                    <li><a title="" href="/Pagess/chuyen-phat-hanh-buu-dien.aspx"><i class="fa fa-university"></i>Chuyển phát hành qua bưu điện</a></li>
                                    <li><a title="" href="/Pagess/don-vi-chuyen-phat.aspx"><i class="fa fa-university"></i>Đơn vị chuyển phát</a></li>
                                    <li><a title="" href="/Pagess/pham-vi-noi-den.aspx"><i class="fa fa-university"></i>Phạm vi nơi đến</a></li>
                                    <li><a title="" href="/Pagess/pham-vi-trong-luong.aspx"><i class="fa fa-university"></i>Phạm vi trọng lượng</a></li>
                                    <li><a title="" href="/Pagess/thong-tin-buu-dien.aspx"><i class="fa fa-university"></i>Thông tin bưu điện</a></li>
                                    <%}%>
                                </ul>
                            </li>
                            <%} %>
                    ...
                    <li><a title="" href="#"><i class="fab fa-medapps"></i><%=Resources.Common.lblTienIch %><span class="arrow"></span></a>
                        <ul class="sub-menu">
                            ...
                            <%-- Van Phong Pham --%>
                            <li>
                                <a title="" href="#"><i class="fa fa-bank"></i><%=Resources.Common.lblQuanLyVanPhongPham %><span class="arrow"></span></a>
                                <ul class="sub-menu">
                                    <%if (CheckQuyen(CurrentUser.QuyenHan, (int)Viags.Utils.Enum.QuyenHan.Phonghop))
                                      {%>
                                        <li><a title="" href="/Pagess/van-phong-pham.aspx"><i class="fa fa-calendar"></i><%=Resources.Common.lblVanPhongPham %></a></li>
                                        <li><a title="" href="/Pagess/van-phong-pham-don-vi-tinh.aspx"><i class="fa fa-calendar"></i><%=Resources.Common.lblVanPhongPhamDonViTinh %></a></li>
                                    <%}%>
                    ...
                    <%--BEGIN Trung tâm giải đáp thông tin --%>
                    <li><a title="" href="/Pagess/trung-tam-giai-dap.aspx"><i class="fas fa-question"></i>Trung tâm giải đáp</a></li>
                    <li><a title="" href="/Pagess/phan-hoi-thong-tin.aspx"><i class="fab fa-replyd"></i>Phản hồi thông tin</a></li>
                    <!--END-->
                </ul>
            </li>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu">
                            ...
                            <li><a title="Sổ văn bản" href="/Pagess/so-van-ban.aspx"><i class="fa fa-book"></i><%=Resources.Common.lblSoVanBan %></a></li>
                              <li><a title="Cây Phê Duyệt" href="/Pagess/cay-phe-duyet.aspx"><i class="fa fa-reorder"></i>Cây Phê Duyệt</a></li>
                        </ul>
                    </li>
                    <%} %>
                        ...
                        if (linkCheck.indexOf(currentUrl) > -1) {
                            ...
                            if (parseInt(index) > 0) {
                                if (linkCheck.indexOf(Urllink) > -1) {
                                    ...
                                    // cấp 6
                                    $(this).parent("li").parent().parent().parent().parent().parent().parent().parent().addClass("active").addClass("open");
                                    $(this).parent("li").parent().parent().parent().parent().parent().parent().parent().find("a span.arrow").addClass("open");
                                    // cấp 7
                                    $(this).parent("li").parent().parent().parent().parent().parent().parent().parent().parent().addClass("active").addClass("open");
                                    $(this).parent("li").parent().parent().parent().parent().parent().parent().parent().parent().find("a span.arrow").addClass("open");
                                    // cấp 8
                                    $(this).parent("li").parent().parent().parent().parent().parent().parent().parent().parent().parent().addClass("active").addClass("open");
                                    $(this).parent("li").parent().parent().parent().parent().parent().parent().parent().parent().parent().find("a span.arrow").addClass("open");
                                    //  return false;
                                }
                            }
                            else {
