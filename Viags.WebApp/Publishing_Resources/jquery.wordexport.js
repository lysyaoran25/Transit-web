    ...
    (function($) {
        $.fn.wordExport = function(fileName) {
           ...
           // var styles = "";
            ...
            var styles = '<style>@page WordSection1{size: 841.95pt 595.35pt;mso-page-orientation: landscape;}div.WordSection1 {page: WordSection1;}table{border-collapse:collapse;}td,th{border:1px gray solid;width:5em;padding:2px;}</style>';
