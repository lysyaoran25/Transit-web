...
!function ($) {
    ...
    var Datetimepicker = function (element, options) {
        ...
        this.component = this.element.is('.date1') ? this.element.find('.add-on .icon-th, .add-on .icon-time, .add-on .fa-calendar').parent() : false;
        this.componentReset = this.element.is('.date1') ? this.element.find('.add-on .icon-remove').parent() : false;
    ...
    var DPGlobal = {
        ...
        headTemplate: '<thead>' +
							'<tr>' +
								'<th class="prev"><i class="fa fa-angle-left"/></th>' + //icon modifed by keenthemes.
								'<th colspan="5" class="switch"></th>' +
								'<th class="next"><i class="fa fa-angle-right"/></th>' + //icon modifed by keenthemes.
							'</tr>' +
						'</thead>',
