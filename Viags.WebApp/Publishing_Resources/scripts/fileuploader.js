...
qq.FileUploaderBasic = function (o) {
    this._options = {
        ...
        // messages                
        messages: {
            typeError: "Chỉ được phép tải các file có các đuôi: {extensions}.",
            ...
            onLeave: "File của bạn đang được upload. Nếu bản rời bỏ trang này thì file upload sẽ bị hủy."
        },
        showMessage: function (message) {
            //alert(message);
            createMessage("Thông báo", message);
        }
    };
...
qq.FileUploader = function (o) {
    ...
    qq.extend(this._options, {
        ...
        template: '<div class="qq-uploader">' +
                ...
                '<div class="qq-upload-button"><i class=" icon-paper-clip"></i> ' + this._options.title + '</div>' + //quangndfix add icon
...
function createMessage(title, message) {
    ...
    $('#dialog-message').modal({ width: 650 });
}