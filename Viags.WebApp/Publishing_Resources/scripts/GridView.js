...
function registerGridView(selector) {
    ...
    $(selector + " .gridView tr").not("first").click(function () {
        if ($(selector + " .gridView tr").hasClass("tdunread") == false) {
    ...
    $(selector + " .bottom-pager select").change(function () {
        ...
        var p = $(selector + " .bottom-pager input").val();
    ...
    // Đăng ký gửi nhiều
    $(selector + " .gridView a.sendAll").click(function () {
        var arrRowId = '';
        var rowTitle = '';
        var linkFW = '';
        var linkFW = (linkFW == '') ? '#' + urlHideFrefix + 'Page=1' : '#' + urlApprovedFrefix + linkFW;
    ...
    $(selector + " .gridView a.giveBackAll").click(function () {
        var arrRowId = '';
        var rowTitle = '';
        var linkFW = '';
        var linkFW = (linkFW == '') ? '#' + urlHideFrefix + 'Page=1' : '#' + urlApprovedFrefix + linkFW;
    ...
    $(selector + " .gridView a.baocaoAll").click(function () {
        var arrRowId = '';
        var rowTitle = '';
        var linkFW = '';
        var linkFW = (linkFW == '') ? '#' + urlHideFrefix + 'Page=1' : '#' + urlApprovedFrefix + linkFW;
    ...
    //Duyệt hủy tài liệu
    $(selector + " .gridView a.approvedDestructionAll").click(function () {
        var arrRowId = '';
        var rowTitle = '';
        var linkFW = '';
    ...
    //đăng ký sửa row
    $(selector + " .gridView a.edit-customer").click(function () {
        var urlRequest = '';
        if (urlForm.indexOf('?') > 0)
            urlRequest = urlForm + '&do=edit&ItemId=' + $(this).attr("href").substring(1);
        else
    ...
    //đăng ký config row
    $(selector + " .gridView a.configuser").click(function () {
        var urlRequest = '';
    ...
    //đăng ký config row
    $(selector + " .gridView a.config-vaitro").click(function () {
        var urlRequest = '';
    ...
    $(selector + " .gridView a.GridApprovedRom").click(function () {
        var w = $(this).attr("popup-w");
        var urlRequest = '';
        if (urlView.indexOf('?') > 0)
...
function registerGridViewCV(selector) {
    ...
    $(selector + " .bottom-pager select").change(function () {
        ...
        initAjaxLoad("/CongViec/pListTongHopCongViec.aspx", '#gridview-container', selector);
        var urlFWs = $.address.value();
        var p = $(selector + " .bottom-pager input").val();
...
function createUploaderHSTL() {

    var listFileAllow = [".pdf", ".PDF"];

    var uploader = new qq.FileUploader({
        element: document.getElementById('btnChosse'),
        action: '/UploadFileHSTL.aspx',
        sizeLimit: 81457280.000008244,
        debug: true,
        onSubmit: function (id, fileName) {
            if (listFileAllow.indexOf(fileName.substring(fileName.lastIndexOf('.'))) == -1) {
