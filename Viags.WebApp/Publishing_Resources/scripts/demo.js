...
/**ham lien quan toi gridview**/
var DemoGridView = function () {
    return {
        init: function () {
            domo();
            hightlight();
...
function domo() {
    ...
    $(document).bind('keydown', 'esc', function assets() {
        $(".modal-footer .red").click();
        return false;
    });
    /*button nhap lai popup*/
    $(document).bind('keydown', 'Alt+c', function assets() {
        $('.form-horizontal').find('input:text,textarea').each(function (index) {
            $(this).val('');
        });
        return false;
    });
    ...
    $(document).bind('keydown', 'down', function assets() {
        up_hightlight();
        return false;
    });

    $(document).bind('keydown', 'up', function assets() {
        down_hightlight();
        return false;
    });
    /*button nhap lai*/
    jQuery(document).ready(function () {
        $('.action-form .purple,.modal-footer .purple').click(function () {
            $('.form-horizontal').find('input:text,textarea').each(function (index) {
                $(this).val('');
            });
        });
...
function up_hightlight() {
    var _index = 0;
    $("table tbody tr").each(function (index) {
        if ($(this).hasClass("yellow-custom")) {

        }
    });
}
function down_hightlight() {

}
function hightlight() {
    //jQuery(document).ready(function () {
    //    $("data-table table tbody tr td").click(function () {
    //        $("table tbody tr").removeClass("yellow-custom");
    //        $(this).parent().addClass("yellow-custom");
    //    });
    //});
}
...
function checkAll() {
    jQuery(document).ready(function () {
        $('.checkAll').click(function (e) {
            $(this).closest('table').find('td div span input:checkbox').prop('checked', this.checked);
        });
