...
(function (factory) {
    ...
    $.extend($.validator, {
        ...
        messages: {
            ...
            url: "Nhập chưa đúng định dạng url.",
            date: "Nhập chưa đúng định dạng ngày tháng.",
            dateISO: "Please enter a valid date ( ISO ).",
            number: "Phải nhập dạng số.",
            digits: "Phải nhập dạng số.",
            creditcard: "Please enter a valid credit card number.",
            equalTo: "Mật khẩu nhập lại không đúng.",
            maxlength: $.validator.format("Phải nhập ít hơn {0} ký tự."),
            minlength: $.validator.format("Phải nhập nhiều hơn {0} ký tự."),
            ...
            min: $.validator.format("Phải nhập giá trị lớn hơn {0}.")
        },
        ...
        prototype: {
            ...
            showErrors: function (errors) {
                ...
                $.each(this.errorList, function (index, error) {
                    ...
                    $($element).parent().children(".select2-container").attr("data-original-title", "Trường dữ liệu này cần phải nhập");
                    $($element).parent().children(".select2-container").attr("role", "tooltip")
                    $(".error").tooltip();
                });
        ...
        methods: {
            ...
            date: function (value, element) {
                ...
                return this.optional(element) || !/Invalid|NaN/.test(new Date(str).toString());
            },
